function ClusteringKDBA(DataSetStartIndex, DataSetEndIndex)  
    ...
    for i = 1:length(Datasets)
            ...
            if (i>=DataSetStartIndex & i<=DataSetEndIndex)
                    ...
                    for rep = 1 : 10
                        ...
                        tic;
                        [labels centroids] = kDBA(DS.Data, length(DS.ClassNames));
            ...
            dlmwrite( strcat( 'RESULTS_ClusteringKDBA_', num2str(DataSetStartIndex), '_', num2str(DataSetEndIndex) ,'.results'), results, 'delimiter', '\t');
