function ClusteringKShapeDTW(DataSetStartIndex, DataSetEndIndex, thisrun)  
    ...
    for i = 1:length(Datasets)
            ...
            if (i>=DataSetStartIndex & i<=DataSetEndIndex)
                    ...
                    for rep = 1 : 10
                        ...
                        tic;
                        [labels centroids] = kShapeDTW(DS.Data, length(DS.ClassNames));
            ...
            dlmwrite( strcat( 'RESULTS_ClusteringKShapeDTW_', num2str(DataSetStartIndex), '_', num2str(DataSetEndIndex) ,'_', num2str(thisrun),'.results'), results, 'delimiter', '\t');
